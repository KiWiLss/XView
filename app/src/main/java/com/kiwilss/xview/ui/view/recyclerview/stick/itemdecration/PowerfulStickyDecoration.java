package com.kiwilss.xview.ui.view.recyclerview.stick.itemdecration;
...
import com.kiwilss.xview.ui.view.recyclerview.stick.itemdecration.cache.CacheUtil;
...
public class PowerfulStickyDecoration extends BaseDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isFirstInGroup(realPosition) || isFirstInRecyclerView(realPosition, i)) {
                ...
                //绘制分割线
                drawDivide(c, parent, childView, realPosition, left + mLeftPadding, right - mRightPadding);
            }
        }
    }
    ...
    public static class Builder {
         ...
         * @return this
         */
        public Builder setDivideLeftPadding(int padding) {
            mDecoration.mLeftPadding = padding;
            return this;
        }
        /**
         * 设置分割线右侧间距
         ...
         * @return this
         */
        public Builder setDivideRightPadding(int padding) {
            mDecoration.mRightPadding = padding;
            return this;
        }
