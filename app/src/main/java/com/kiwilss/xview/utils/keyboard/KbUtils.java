...
public final class KbUtils {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) Utils.INSTANCE.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) Utils.INSTANCE.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
