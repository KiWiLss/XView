 ...
 */
public class NoPaddingTextView2 extends AppCompatTextView {
    //日志标记
    private final String TAG = NoPaddingTextView2.class.getSimpleName();
    //文本画笔
     ...
     * @param attrs
     */
    public NoPaddingTextView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * @param defStyleAttr
     */
    public NoPaddingTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
